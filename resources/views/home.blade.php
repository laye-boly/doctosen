                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-12 mx-auto">
                                <div class="booking-form">
                                    ...
                                    <h2 class="text-center mb-lg-3 mb-2" id="consultation-booking">Consulation en ligne ou en présentiel</h2>
                                    <div class="form-search">
                                        {!! Form::open(['url' => route('home'), 'class' => 'row g-3 needs-validation', 'id' => 'registration-form']) !!}

                                       <div class="col-md-6">           
                                            {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'nom ou prénom du médecin']) }}
                                        </div>
                                        <div class="col-md-6">           
                                            {{ Form::text('title', null, ['class' => 'form-control', 'placeholder' => 'spécialité du médecin']) }}
                                        </div>
                                        <div class="col-md-4">           
                                            {{ Form::text('adress', null, ['class' => 'form-control',  'placeholder' => 'adresse du médecin']) }}
                                        </div>
                                        ...
                                        <div class="col-md-6">           
                                            {{Form::select('order_column', ['schedule_date' => 'date du rendez-vous', 'doctor_name' => 'nom du médecin', 'doctor_title' => 'spécialité', 'doctor_adress' => 'adresse du médecin'], null, ['placeholder' => 'Ordonner par']) }}
                                        </div>

                                        <div class="col-md-6">           
                                            {{Form::select('order_by', ['asc' => 'Par odre croissant', 'desc' => 'Par odre décroissant'], null, ['placeholder' => "Le sens de l'ordre"]) }}
                                        </div>
                                    ...
                                    @if(count($consultationsSchedules) > 0)
                                        <table class="table table-striped mt-5 mb-5">
                                            <thead>
                                            <tr>
                                                <th>Prénom et nom du médecin </th>
                                    ...
                                    @else
                                        <div>
                                            <h6 class="text-center">Aucun résultat ne correspond à votre</h6>
                                        </div>
                                    @endif
                                ...
                                <div class="booking-form mt-5 pd-5">
                                    ...
                                    <div class="form-search">
                                       ...
                                       <div class="col-md-6">           
                                            {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => "nom de l'hôpital"]) }}
                                        </div>
                                        <div class="col-md-6">           
                                        ...
                                        <div class="col-md-4">           
                                            {{ Form::text('adress', null, ['class' => 'form-control',  'placeholder' => "adresse de l'hôpital"]) }}
                                        </div>
                                        ...
                                        <div class="col-md-6">           
                                            {{Form::select('order_column', ['schedule_date' => 'date du rendez-vous', 'vaccine_name' => 'nom du vaccin', 'vaccine_type' => 'type de vaccin', 'hospital_name' => "nom de l'hôpital"], null, ['placeholder' => 'Ordonner par']) }}
                                        </div>
                                    ...
                                    @else
                                        <div>
                                            <h6 class="text-center">Aucun résultat ne correspond à cette recherche</h6>
                                        </div>
                                    @endif
