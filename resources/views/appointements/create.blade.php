                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-12 mx-auto">
                                <div class="booking-form">
                                    ...
                                    <h2 class="text-center mb-lg-3 mb-2" id="consultation-booking">Mes rendez vous de consulation</h2>
                                    @if ($errorTime != "no")
                                    ...
                                    @endif
                                        ...
                                        <div class="form-group">
                                            {{Form::label('appointement_hour ', 'Votre heure de rendez-vous')}}
                                            {{Form::text('appointement_hour', '', ['class' => 'form-control', 'placeholder' => 'exemple 10:45'])}}
                                        </div>
                                        <div class="form-group">
                                            {{Form::label('appointement_reason ', "les raison de votre rendez-vous (non obligatoire)")}}
                                            {{Form::textarea ('appointement_reason', '', ['class' => 'form-control'])}}
                                        </div>
                                        <div class="form-group">
                                
                                            {{Form::hidden('schedule', $schedule, ['class' => 'form-control'])}}
                                        </div>
                                        <div class="form-group">
                                
                                            {{Form::hidden('doctor', $doctor, ['class' => 'form-control'])}}
                                        </div>
