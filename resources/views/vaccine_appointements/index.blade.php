                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-12 mx-auto">
                                <div class="booking-form">
                                    ...
                                    <h2 class="text-center mb-lg-3 mb-2" id="consultation-booking">Mes rendez vous de vaccination</h2>
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                {{ $appointement->patient->first_name }} {{ $appointement->patient->last_name }}
                                                
                                        </td>
                                            <td>{{ $appointement->appointement_date }}</td>
                                            <td>{{ $appointement->appointement_hour }}</td>
                                            <td>{{ $appointement->status }}</td>
                                            <td><a class="btn btn-info" href="{{route('vaccine.appointement.show', ['vaccineAppointement' => $appointement->id])}}">Voir les détails</a></td>
                                            <td><a class="btn btn-info" href="{{route('vaccine.appointement.download', ["vaccineAppointement" => $appointement->id])}}">Télécharger</a></td>
