                ...
                <div class="container">
                    ...
                    <div class="col-lg-8 col-12 mx-auto">
                        ...
                        @endif
                            ...
                            {!! Form::open(['url' => route('hospital.update', ['hospital' => $hospital])]) !!}
                            <div class="form-group">
                                {{Form::label('nom ', 'nom')}}
                                {{Form::text('name', $hospital->name, ['class' => 'form-control', 'placeholder' => 'nom du lieu de travail'])}}
                            </div>
                            <div class="form-group">
                                {{Form::label('adress ', 'adresse')}}
                                {{Form::text('adress', $hospital->adress, ['class' => 'form-control', 'placeholder' => 'adresse du lieu de travail'])}}
                            </div>
                            <div class="form-group">
                                {{Form::label('phone ', 'téléphone')}}
                                {{Form::text('phone', $hospital->phone, ['class' => 'form-control', 'placeholder' => 'lieu de travail'])}}
                            </div>
