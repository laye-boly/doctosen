                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-12 mx-auto">
                                <div class="booking-form">
                                    ...
                                    <h5 class="text-center mb-lg-3 mb-2"> Modifier le diplôme</h5>
                                    <h5 class="text-center mb-lg-3 mb-2"> Ce diplôme remplacera l'ancien</h5>
                                    ...
                                    {!! Form::open(['url' => route('diploma.update', ['diploma' => $diploma->id]), 'files' => true]) !!}

                                    <div class="form-group">
                                        {{Form::label('title ', 'titre du diplome')}}
                                        {{Form::text('title', $diploma->title, ['class' => 'form-control', 'placeholder' => 'le titre du diplome'])}}
                                    </div>
                                    <div class="form-group">
                                        {{Form::label('year ', "année d'obtention du diplôme")}}
                                        {{Form::text('year', $diploma->year, ['class' => 'form-control', 'placeholder' => "année d'obtention du diplôme"])}}
                                    </div>
                                    <div class="form-group">
