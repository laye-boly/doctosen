...
<html lang="en">
    ...
    <body id="top">
        ...
        <main>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="alert alert-info">
                               ...
                               Nombre de diplôme : <span  id="diploma-number">{{count($diplomas)}}</span> 
                            </div>
                            {{-- S'il y a des erreurs de lors de la supression d'un diplome --}}
                            @if ($errors->any())
                            ...
                            {{-- fin On garde le nombre de diplome pour avertir l'utilisateur quand il veut supprimer via JS --}}
                            <h5 class="text-center mb-lg-3 mb-2"> <a href="{{route('diploma.create')}}">Ajouter un nouveau diplôme</a></h5>
                            <h5 class="text-center mb-lg-3 mb-2"> Mes diplômes</h5>
                            @if (count($diplomas) != 0)
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn btn-info" href="{{route('diploma.edit', ['diploma' => $diploma->id])}}">Modifier</a></td>
                                        <td><a class="btn btn-info" href="{{route('diploma.download', ['filename' => $diploma->image])}}">Télécharger</a></td>
                                        <td>
                                            {!! Form::open(['url'  => route('diploma.delete', ['diploma' => $diploma->id])]) !!}

                                            {{Form::hidden('diploma-id', $diploma->id)}}
                                            {{Form::submit("supprimer", ['class' => 'btn btn-info'])}}
            ...
            <!-- JAVASCRIPT FILES -->
          <!-- JAVASCRIPT FILES -->
          <script src="../../../../../js/doctosen.delete.diploma.js"></script>
