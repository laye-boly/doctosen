...
<html lang="en">
    ...
    <body id="top">
        ...
        <main>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-12 mx-auto">
                                <div class="booking-form">
                                    ...
                                    <h5 class="text-center mb-lg-3 mb-2"> Ajouter un vaccin</h5>
                            ...
                            <div class="alert alert-info">
                               ...
                               Nombre de vaccins : <span  id="vaccine-number">{{count($vaccines)}}</span> 
                            </div>
                            ...
                            <h5 class="text-center mb-lg-3 mb-2"> <a href="{{route('vaccine.create')}}">Ajouter un nouveau vaccin</a></h5>
                            <h5 class="text-center mb-lg-3 mb-2"> Mes vaccins</h5>
                            @if (count($vaccines) != 0)
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-info" href="{{route('vaccine.edit', ['vaccine' => $vaccine->id])}}">Modifier</a>
                                        </td>
                                    <td>
                                       
                                            {!! Form::open(['url'  => route('vaccine.delete', ['vaccine' => $vaccine->id])]) !!}

                                            {{Form::hidden('vaccine-id', $vaccine->id)}}
            ...
            <!-- JAVASCRIPT FILES -->
            <script src="../../../../../js/doctosen.delete.vaccine.js"></script>
