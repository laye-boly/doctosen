                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-12 mx-auto">
                                <div class="booking-form">
                                    ...
                                    <h2 class="text-center mb-lg-3 mb-2" id="consultation-booking"><a href="{{route('schedule.create')}}">Ajouter un nouveau emploi de temps</a> </h2>
                                    <h2 class="text-center mb-lg-3 mb-2" id="consultation-booking">Mes emplois de temps</h2>
                                    <table class="table table-striped">
                                        <thead>
                                          <tr>
                                            ...
                                            <th scope="col">durée de la consultation en minutes</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $schedule->consultation_duration }}</td>
                                            <td>@if($schedule->status == 1) activé @else désactive @endif</td>
                                            <td>
                                                {!! Form::open(['url' => '/dashboard/doctor/schedule/delete']) !!}
                                                {{ Form::hidden('schedule_id', $schedule->id)}}
            
                                                {{Form::submit('supprimer', ['class'=>'btn btn-danger'])}}
            
                                                <a class="btn btn-info"  href="/dashboard/doctor/schedule/edit/{{$schedule->id}}">éditer</a>
