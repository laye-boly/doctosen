                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-12 mx-auto">
                                <div class="booking-form">
                                    ...
                                    <h2 class="text-center mb-lg-3 mb-2" id="consultation-booking">Nouveau emploi de temps</h2>
                                    @if ($errorTime != "no")
                                    ...
                                    @endif
                                        ...
                                        {!! Form::open(['url' => '/dashboard/doctor/schedule/store']) !!}
                                        ...
                                        {{ Form::text('consultationDuration', '',  ['class' => 'form-control']) }}
