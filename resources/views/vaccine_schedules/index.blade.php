                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-12 mx-auto">
                                <div class="booking-form">
                                    ...
                                    <h5 class="text-center mb-lg-3 mb-2"> <a href="{{route('vaccine.schedule.create')}}">Ajouter un nouveau emploi de temps de vaccination</a></h5>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info" href="{{route('vaccine.schedule.show', ['vaccineSchedule' => $schedule->id])}}">Détail</a>
                                                </td>
        
                                                <td>
                                                    <a class="btn btn-info" href="{{route('vaccine.schedule.edit', ['vaccineSchedule' => $schedule->id])}}">Modifier</a>
                                                </td>
                                            <td>
