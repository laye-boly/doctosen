...
return [
    ...
    */
    ...
    // 'default' => isset($DATABASE_URL["host"]) ?  env('DB_CONNECTION', 'pgsql') : env('DB_CONNECTION', 'mysql'),
    ...
    */
    ...
    'connections' => [
        ...
        'pgsql' => [
            ...
            'host' => isset($DATABASE_URL["host"]) ? $DATABASE_URL["host"] :  env('DB_HOST', '127.0.0.1'), // pour heroku
            // 'port' => env('DB_PORT', '5432'), // defeult
            'port' => isset($DATABASE_URL['port']) ? $DATABASE_URL['port'] : env('DB_PORT', '5432'), // pour heroku
            ...
            'username' => isset($DATABASE_URL["user"]) ? $DATABASE_URL["user"] : env('DB_USERNAME', 'forge'), // heroku
